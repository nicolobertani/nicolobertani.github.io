...
blogdown.draftdir <- './_drafts'
rmds.all = list.files('.', '[.]Rmd$', recursive = TRUE, full.names = TRUE)
rmds <- rmds.all[substr(rmds.all, 1, nchar(blogdown.draftdir)) != blogdown.draftdir]
